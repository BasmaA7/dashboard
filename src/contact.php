...
if(empty($_POST["name"]) || empty($_POST["number"]) || empty($_POST["email"]) || empty($_POST["message"]))
{
    ...
    $email->setFrom($email,$name,$number);
    $email->addAddress('basmaelandalosy5@gmail.com', 'message');
 ...
 <?php include "../nav_b.php";a?>
  ...
  <section class="flex justify-center items-center  py-32 dark:bg-gray-900">
    <div class="py-8 lg:py-16 px-4 max-w-screen-sm  w-[70%] bg-white border rounded-3xl dark: dark:bg-gray-700 ">
       ...
       <!-- form-->
        <form method="post" class="space-y-8 flex flex-col justify-evenly "  >
            <div>
                <input type="text"  name="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-3xl focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light " placeholder="Contact name" >
                <span class=" text-red-600 hidden" id="name-error">no valid  </span>
            </div>
        
            <div>
                <input type="tel" name="number" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-3xl focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Contact Phone" >
                <span class=" text-red-600 hidden" id="phone-error">no valid </span>
            </div>
            <div>
                <input type="Email"  name="email" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-3xl border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="E-mail" >
                <span class="text-red-600 hidden" id="email-error">no valid </span>
            </div>
            <div class="sm:col-span-2">
                <textarea   name="message" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-3xl shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Let talk about your idea"></textarea>
                <span class=" text-red-600 hidden" id="text-error">no valid </span>
            </div>
            <button type="submit"  name='submit' class="py-3 px-5 text-sm font-medium text-center text-white rounded-3xl bg-orange-600 w-60 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 self-center  ">S U B M I T</button>
        </form>
      ...
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="../src/index.html" class="flex items-center">
            ...
            />
            <span class="self-center lg:visible: lg:text-xl font-semibold whitespace-nowrap dark:text-white">People Per Tasks</span>
          </a>
        </div>
