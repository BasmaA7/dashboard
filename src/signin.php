...
<body class=" bg-gray-100 dark: dark:bg-gray-900 ">
 ...
 <!--FORM-->
      ...
      <div class=" flex justify-center ">
      <div> <h2 class="text-orange-500 font-extrabold mt-4 ">Forgot Password ?</h2></div>
      </div> 
      <div class=  "dark:text-white flex justify-center mt-4 ">  <p>Don't have an account? <a href="../src/signup.html" class="text-blue-600">SignUp</a><p></div> 
    </div>
  </section> 
  <!-- section footer-->
